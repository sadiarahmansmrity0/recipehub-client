    ...
    useEffect(() => {
        const fetchRecipes = async () => {
            try {
                ...
                console.log('✅ Featured recipes:', featuredRes.data);
                console.log('✅ Popular recipes:', popularRes.data);
                
                setFeaturedRecipes(featuredRes.data || []);
                setPopularRecipes(popularRes.data || []);
                
                if (featuredRes.data.length === 0 && popularRes.data.length === 0) {
                    setError('No recipes found. Please add some recipes!');
                }
            } catch (error) {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-white px-4">
                <div className="text-center max-w-md">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 mb-2">No Recipes Available</h2>
        ...
        >
            ...
            <div className="p-5">
                ...
                <Link
                    ...
                    className="mt-4 inline-flex items-center gap-2 text-orange-600 font-semibold hover:text-orange-700 transition-colors text-sm"
                >
            ...
            <section className="py-16 px-6 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-sm text-gray-400 mt-1">{featuredRecipes.length} recipes found</p>
                    </div>
            ...
            <section className="py-16 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-sm text-gray-400 mt-1">{popularRecipes.length} recipes found</p>
                    </div>
